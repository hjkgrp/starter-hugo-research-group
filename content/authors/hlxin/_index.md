...
education:
  ...
  - course: MS in Chemical Engineering
    institution: Tsinghua Univeristy, Beijing, China
    year: 2005
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:hlxin AT mit DOT edu'
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/hongliang-xin-1138491a/
- icon: github
  icon_pack: fab
  link: https://github.com/hlxin
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=P_iNYbQAAAAJ&hl=en
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/XinGroup_VT
# Link to a PDF of your resume/CV from the About widget.
# To enable, copy your resume/CV to `static/files/cv.pdf` and uncomment the lines below.
- icon: cv
  icon_pack: ai
  link: files/CV_hlx.pdf
